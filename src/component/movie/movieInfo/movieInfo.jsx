                ...
                <div className={st.filmBio}>
                    ...
                    <div className={st.movieInfo}>
                        ...
                        <div className={st.moviData}>
                            ...
                            <span style={{color:dark ? '' : 'black'}}>{movie && movie.movie_premeire_date} г.</span>
                        </div>
                        <div className={st.moviData}>
                        ...
                        <div className={`${st.genre} ${!dark ? st.dark : ''}`}>
                            {
                                ...
                                movie && movie.movie_genre && movie.movie_genre.split(',').map((i,key)=><Link
                                to={`/${params.lang || 'ru'}/genres/${i}`}
                                key={key}>{i}
                                </Link>)
                            }
                        </div>
